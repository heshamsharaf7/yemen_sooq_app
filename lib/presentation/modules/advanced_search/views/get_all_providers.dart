...
class GetAllProviders extends StatelessWidget {
  const GetAllProviders({super.key});
                  ...
                  return Column(
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () => controller.selectMainService(
                              controller.mainServices![index]),
                          child: Container(
                              decoration: BoxDecoration(
                                color: controller.selectedMainSeervice!.id ==
                                        controller.mainServices![index].id
                                    ? AppColor.primary
                                    : Colors.grey[400],
                              ...
                              child: Center(
                                  child: Text(
                                      "    ${controller.mainServices![index].name}    "))),
                        ),
                      ),
                    ],
                  );
                        ...
                        return Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: InkWell(
                                onTap: () => controller.selectProvidersService(
                       ...
                       GetBuilder<AdvancedController>(
                          builder: (con) => controller.providers.length == 0
                              ...
                              : GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var item = controller.providers[index];
                                    return Padding(
